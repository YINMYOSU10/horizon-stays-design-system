...
-Cosponent workshop: Storybook 10 (react-vite)
• Tests: Vitest
- Accessibility: Storybook ally addon
...
- Token source: `tokens/tokens.json` (exported fron Figma, conmitted)
...
- Match the package manager in this flle. This project uses npm, not yarn or pnpm.
- Use the existing package scripts before inventing conmands.
